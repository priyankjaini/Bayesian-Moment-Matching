...
% dbstop in momentMatchingMartingale at 76 if (alpha<0)
% dbstop in momentMatchingMartingale at 76 if (beta<0)
% dbstop in momentMatchingMartingale at 76 if (gamma<0)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% MOMENTS OF A DIRICHLET %%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% FIRST ORDER MOMENTS %%%
